...
public class StartMoveCommand: ICommand
{
    ...
    public void Execute()
    {
        ...
        var cmd = IoC.Resolve<ICommand>("Game.Operation.Move", _moveCommandStartable.Target); // 2. cmd = Конструивание длительной операции (IoC.Resolve<ICommand>("Game.Operation.Move"))
